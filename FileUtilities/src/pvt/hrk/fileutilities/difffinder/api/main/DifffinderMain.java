...
public class DifffinderMain {
	...
	public static void main(String[] args) {
		if (args != null && args.length >= 3) {
			...
			try {
				FindDifference.findDifference(new  File(sourceDir), new  File(targetDir), MyFileFilterBuilder.EXCLUDE_AUTOGENERATED_FILES,new CSVStreamResultHandler(new File(resultFile)));
